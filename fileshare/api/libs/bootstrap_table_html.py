class _BootstrapTableHtmlTemplate:
    ...
    T_OPS_OPEN_FILE_NEW_TAB: str    = """<a class="ops-btn" href="{path}" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i></a>"""
    T_OPS_OPEN_DIR_NEW_TAB: str     = """<a class="ops-btn" href="/?path={path}" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i></a>"""

    T_OPS_DOWNLOAD: str             = """<a class="ops-btn" href="{path}" ><i class="fa fa-download" aria-hidden="true"></i></a>"""

    T_OPS_DELETE: str               = """<a class="ops-btn" href="{path}" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>"""
    
    T_OPS_RENAME: str               = """<a class="ops-btn" href="{path}" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>"""
    
    T_OPS_MOVE: str                 = """<a class="ops-btn" href="{path}" ><i class="fa fa-exchange" aria-hidden="true"></i></a>"""
